        ...
        <div>
          ...
          <div className="flex flex-col gap-y-[24px] md:gap-y-[48px]">
            <p className="max-w-[500px] italic">
              ...
              people, pop culture can feel like a mirror, reflecting the things
              we care about while influencing how we see ourselves. Whether it’s
              the music we blast, the TikTok trends we mimic, or the movies we
              rewatch, pop culture is a constant force shaping identity in ways
